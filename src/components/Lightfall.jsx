...
const Lightfall = ({
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      callIfFunction(programRef.current, 'remove')
      callIfFunction(geometryRef.current, 'remove')
      callIfFunction(meshRef.current, 'remove')
      callIfFunction(rendererRef.current, 'destroy')
